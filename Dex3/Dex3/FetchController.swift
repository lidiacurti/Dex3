...
struct FetchController {
    ...
    func fetchAllPokemon() async throws -> [TempPokemon]? {
        ...
        //non posso aggiungere query parameters direttamente all'url ma solo agli URLComponents
        fetchComponents?.queryItems = [URLQueryItem(name: "limit", value: "386")] // numero di pokemon delle prime 3 generazioni
        ...
        // questo perchè l'api restituisce un name e url e non la struttura del tempPokemon
    ...
    private func havePokemon() -> Bool {
        ...
        // per vedere se ci sono il primo e l'ultimo pokemon
        ...
        do {
            ...
            if checkPokemon.count == 2 {
                // vuol dire che abbiamo tutti i pokemon nel db
                return true
            }
        } catch {
